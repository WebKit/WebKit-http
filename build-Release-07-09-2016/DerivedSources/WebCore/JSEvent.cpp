...
JSC::EncodedJSValue jsEventScoped(JSC::ExecState*, JSC::EncodedJSValue, JSC::PropertyName);
JSC::EncodedJSValue jsEventRelatedTargetScoped(JSC::ExecState*, JSC::EncodedJSValue, JSC::PropertyName);
...
bool fillEventInit(EventInit& eventInit, JSDictionary& dictionary)
{
    ...
    if (!dictionary.tryGetProperty("cancelable", eventInit.cancelable))
        return false;
    if (!dictionary.tryGetProperty("scoped", eventInit.scoped))
        return false;
    if (!dictionary.tryGetProperty("relatedTargetScoped", eventInit.relatedTargetScoped))
        return false;
    return true;
}
...
static const HashTableValue JSEventPrototypeTableValues[] =
{
    ...
    { "scoped", ReadOnly | CustomAccessor, NoIntrinsic, { (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsEventScoped), (intptr_t) static_cast<PutPropertySlot::PutValueFunc>(0) } },
    { "relatedTargetScoped", ReadOnly | CustomAccessor, NoIntrinsic, { (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsEventRelatedTargetScoped), (intptr_t) static_cast<PutPropertySlot::PutValueFunc>(0) } },
...
void JSEventPrototype::finishCreation(VM& vm)
{
    ...
    if (!RuntimeEnabledFeatures::sharedFeatures().shadowDOMEnabled()) {
        Identifier propertyName = Identifier::fromString(&vm, reinterpret_cast<const LChar*>("scoped"), strlen("scoped"));
        VM::DeletePropertyModeScope scope(vm, VM::DeletePropertyMode::IgnoreConfigurable);
        JSObject::deleteProperty(this, globalObject()->globalExec(), propertyName);
    }
    if (!RuntimeEnabledFeatures::sharedFeatures().shadowDOMEnabled()) {
        Identifier propertyName = Identifier::fromString(&vm, reinterpret_cast<const LChar*>("relatedTargetScoped"), strlen("relatedTargetScoped"));
        VM::DeletePropertyModeScope scope(vm, VM::DeletePropertyMode::IgnoreConfigurable);
        JSObject::deleteProperty(this, globalObject()->globalExec(), propertyName);
    }
}
...
EncodedJSValue jsEventScoped(ExecState* state, EncodedJSValue thisValue, PropertyName)
{
    UNUSED_PARAM(state);
    UNUSED_PARAM(thisValue);
    JSValue decodedThisValue = JSValue::decode(thisValue);
    auto* castedThis = jsDynamicCast<JSEvent*>(decodedThisValue);
    if (UNLIKELY(!castedThis)) {
        return throwGetterTypeError(*state, "Event", "scoped");
    }
    auto& impl = castedThis->wrapped();
...
EncodedJSValue jsEventRelatedTargetScoped(ExecState* state, EncodedJSValue thisValue, PropertyName)
{
    UNUSED_PARAM(state);
    UNUSED_PARAM(thisValue);
    JSValue decodedThisValue = JSValue::decode(thisValue);
    auto* castedThis = jsDynamicCast<JSEvent*>(decodedThisValue);
    if (UNLIKELY(!castedThis)) {
        return throwGetterTypeError(*state, "Event", "relatedTargetScoped");
    }
    auto& impl = castedThis->wrapped();
    JSValue result = jsBoolean(impl.relatedTargetScoped());
    return JSValue::encode(result);
}
