...
bool setJSCanvasRenderingContext2DWebkitLineDashOffset(ExecState* state, EncodedJSValue thisValue, EncodedJSValue encodedValue)
{
    ...
    if (UNLIKELY(state->hadException()))
        return false;
    impl.setWebkitLineDashOffset(WTFMove(nativeValue));
    return true;
}
...
EncodedJSValue JSC_HOST_CALL jsCanvasRenderingContext2DPrototypeFunctionQuadraticCurveTo(ExecState* state)
{
    ...
    if (UNLIKELY(state->argumentCount() < 4))
        return throwVMError(state, createNotEnoughArgumentsError(state));
    auto cpx = convert<float>(*state, state->argument(0), ShouldAllowNonFinite::Yes);
    if (UNLIKELY(state->hadException()))
        return JSValue::encode(jsUndefined());
    auto cpy = convert<float>(*state, state->argument(1), ShouldAllowNonFinite::Yes);
    if (UNLIKELY(state->hadException()))
        return JSValue::encode(jsUndefined());
    auto x = convert<float>(*state, state->argument(2), ShouldAllowNonFinite::Yes);
    if (UNLIKELY(state->hadException()))
        return JSValue::encode(jsUndefined());
    auto y = convert<float>(*state, state->argument(3), ShouldAllowNonFinite::Yes);
    if (UNLIKELY(state->hadException()))
        return JSValue::encode(jsUndefined());
...
EncodedJSValue JSC_HOST_CALL jsCanvasRenderingContext2DPrototypeFunctionBezierCurveTo(ExecState* state)
{
    ...
    if (UNLIKELY(state->argumentCount() < 6))
        return throwVMError(state, createNotEnoughArgumentsError(state));
    auto cp1x = convert<float>(*state, state->argument(0), ShouldAllowNonFinite::Yes);
    if (UNLIKELY(state->hadException()))
        return JSValue::encode(jsUndefined());
    auto cp1y = convert<float>(*state, state->argument(1), ShouldAllowNonFinite::Yes);
    if (UNLIKELY(state->hadException()))
        return JSValue::encode(jsUndefined());
    auto cp2x = convert<float>(*state, state->argument(2), ShouldAllowNonFinite::Yes);
    if (UNLIKELY(state->hadException()))
        return JSValue::encode(jsUndefined());
    auto cp2y = convert<float>(*state, state->argument(3), ShouldAllowNonFinite::Yes);
    if (UNLIKELY(state->hadException()))
        return JSValue::encode(jsUndefined());
    auto x = convert<float>(*state, state->argument(4), ShouldAllowNonFinite::Yes);
    if (UNLIKELY(state->hadException()))
        return JSValue::encode(jsUndefined());
...
EncodedJSValue JSC_HOST_CALL jsCanvasRenderingContext2DPrototypeFunctionArcTo(ExecState* state)
{
    ...
    if (UNLIKELY(state->argumentCount() < 5))
        return throwVMError(state, createNotEnoughArgumentsError(state));
    ExceptionCode ec = 0;
    auto x1 = convert<float>(*state, state->argument(0), ShouldAllowNonFinite::Yes);
    if (UNLIKELY(state->hadException()))
        return JSValue::encode(jsUndefined());
    auto y1 = convert<float>(*state, state->argument(1), ShouldAllowNonFinite::Yes);
    if (UNLIKELY(state->hadException()))
        return JSValue::encode(jsUndefined());
    ...
    if (UNLIKELY(state->hadException()))
        return JSValue::encode(jsUndefined());
    auto radius = convert<float>(*state, state->argument(4), ShouldAllowNonFinite::Yes);
    if (UNLIKELY(state->hadException()))
        return JSValue::encode(jsUndefined());
...
EncodedJSValue JSC_HOST_CALL jsCanvasRenderingContext2DPrototypeFunctionRect(ExecState* state)
{
    ...
    if (UNLIKELY(state->hadException()))
        return JSValue::encode(jsUndefined());
    impl.rect(WTFMove(x), WTFMove(y), WTFMove(width), WTFMove(height));
    return JSValue::encode(jsUndefined());
}
...
EncodedJSValue JSC_HOST_CALL jsCanvasRenderingContext2DPrototypeFunctionArc(ExecState* state)
{
    ...
    if (UNLIKELY(state->hadException()))
        return JSValue::encode(jsUndefined());
    auto radius = convert<float>(*state, state->argument(2), ShouldAllowNonFinite::Yes);
    if (UNLIKELY(state->hadException()))
        return JSValue::encode(jsUndefined());
    auto startAngle = convert<float>(*state, state->argument(3), ShouldAllowNonFinite::Yes);
    if (UNLIKELY(state->hadException()))
        return JSValue::encode(jsUndefined());
    auto endAngle = convert<float>(*state, state->argument(4), ShouldAllowNonFinite::Yes);
    if (UNLIKELY(state->hadException()))
        return JSValue::encode(jsUndefined());
...
EncodedJSValue JSC_HOST_CALL jsCanvasRenderingContext2DPrototypeFunctionEllipse(ExecState* state)
{
    ...
    if (UNLIKELY(state->hadException()))
        return JSValue::encode(jsUndefined());
    auto radiusX = convert<float>(*state, state->argument(2), ShouldAllowNonFinite::Yes);
    if (UNLIKELY(state->hadException()))
        return JSValue::encode(jsUndefined());
    auto radiusY = convert<float>(*state, state->argument(3), ShouldAllowNonFinite::Yes);
    if (UNLIKELY(state->hadException()))
        return JSValue::encode(jsUndefined());
    auto rotation = convert<float>(*state, state->argument(4), ShouldAllowNonFinite::Yes);
    if (UNLIKELY(state->hadException()))
        return JSValue::encode(jsUndefined());
    auto startAngle = convert<float>(*state, state->argument(5), ShouldAllowNonFinite::Yes);
    if (UNLIKELY(state->hadException()))
        return JSValue::encode(jsUndefined());
    auto endAngle = convert<float>(*state, state->argument(6), ShouldAllowNonFinite::Yes);
    if (UNLIKELY(state->hadException()))
        return JSValue::encode(jsUndefined());
...
EncodedJSValue JSC_HOST_CALL jsCanvasRenderingContext2DPrototypeFunctionDrawImage(ExecState* state)
{
    ...
    JSValue arg0(state->argument(0));
    if ((argsCount == 3 && ((arg0.isObject() && asObject(arg0)->inherits(JSHTMLImageElement::info())))))
        return jsCanvasRenderingContext2DPrototypeFunctionDrawImage1(state);
    if ((argsCount == 5 && ((arg0.isObject() && asObject(arg0)->inherits(JSHTMLImageElement::info())))))
        return jsCanvasRenderingContext2DPrototypeFunctionDrawImage2(state);
    if ((argsCount == 9 && ((arg0.isObject() && asObject(arg0)->inherits(JSHTMLImageElement::info())))))
        return jsCanvasRenderingContext2DPrototypeFunctionDrawImage3(state);
    if ((argsCount == 3 && ((arg0.isObject() && asObject(arg0)->inherits(JSHTMLCanvasElement::info())))))
        return jsCanvasRenderingContext2DPrototypeFunctionDrawImage4(state);
    if ((argsCount == 5 && ((arg0.isObject() && asObject(arg0)->inherits(JSHTMLCanvasElement::info())))))
        return jsCanvasRenderingContext2DPrototypeFunctionDrawImage5(state);
    if ((argsCount == 9 && ((arg0.isObject() && asObject(arg0)->inherits(JSHTMLCanvasElement::info())))))
        return jsCanvasRenderingContext2DPrototypeFunctionDrawImage6(state);
#if ENABLE(VIDEO)
    if ((argsCount == 3 && ((arg0.isObject() && asObject(arg0)->inherits(JSHTMLVideoElement::info())))))
        return jsCanvasRenderingContext2DPrototypeFunctionDrawImage7(state);
#endif

#if ENABLE(VIDEO)
    if ((argsCount == 5 && ((arg0.isObject() && asObject(arg0)->inherits(JSHTMLVideoElement::info())))))
        return jsCanvasRenderingContext2DPrototypeFunctionDrawImage8(state);
#endif

#if ENABLE(VIDEO)
    if ((argsCount == 9 && ((arg0.isObject() && asObject(arg0)->inherits(JSHTMLVideoElement::info())))))
...
EncodedJSValue JSC_HOST_CALL jsCanvasRenderingContext2DPrototypeFunctionPutImageData(ExecState* state)
{
    ...
    JSValue arg0(state->argument(0));
    if ((argsCount == 3 && ((arg0.isObject() && asObject(arg0)->inherits(JSImageData::info())))))
        return jsCanvasRenderingContext2DPrototypeFunctionPutImageData1(state);
    if ((argsCount == 7 && ((arg0.isObject() && asObject(arg0)->inherits(JSImageData::info())))))
...
EncodedJSValue JSC_HOST_CALL jsCanvasRenderingContext2DPrototypeFunctionCreatePattern(ExecState* state)
{
    size_t argsCount = std::min<size_t>(2, state->argumentCount());
    JSValue arg0(state->argument(0));
    if ((argsCount == 2 && ((arg0.isObject() && asObject(arg0)->inherits(JSHTMLCanvasElement::info())))))
        return jsCanvasRenderingContext2DPrototypeFunctionCreatePattern1(state);
    if ((argsCount == 2 && ((arg0.isObject() && asObject(arg0)->inherits(JSHTMLImageElement::info())))))
        return jsCanvasRenderingContext2DPrototypeFunctionCreatePattern2(state);
#if ENABLE(VIDEO)
    if ((argsCount == 2 && ((arg0.isObject() && asObject(arg0)->inherits(JSHTMLVideoElement::info())))))
...
EncodedJSValue JSC_HOST_CALL jsCanvasRenderingContext2DPrototypeFunctionCreateImageData(ExecState* state)
{
    size_t argsCount = std::min<size_t>(2, state->argumentCount());
    JSValue arg0(state->argument(0));
    if ((argsCount == 1 && (arg0.isUndefinedOrNull() || (arg0.isObject() && asObject(arg0)->inherits(JSImageData::info())))))
...
EncodedJSValue JSC_HOST_CALL jsCanvasRenderingContext2DPrototypeFunctionDrawFocusIfNeeded(ExecState* state)
{
    size_t argsCount = std::min<size_t>(2, state->argumentCount());
    JSValue arg0(state->argument(0));
    if ((argsCount == 1 && (arg0.isUndefinedOrNull() || (arg0.isObject() && asObject(arg0)->inherits(JSElement::info())))))
        return jsCanvasRenderingContext2DPrototypeFunctionDrawFocusIfNeeded1(state);
    JSValue arg1(state->argument(1));
    if ((argsCount == 2 && ((arg0.isObject() && asObject(arg0)->inherits(JSDOMPath::info()))) && (arg1.isUndefinedOrNull() || (arg1.isObject() && asObject(arg1)->inherits(JSElement::info())))))
