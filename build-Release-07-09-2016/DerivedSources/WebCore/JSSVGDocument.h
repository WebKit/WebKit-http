...
class JSSVGDocument : public JSXMLDocument {
public:
    typedef JSXMLDocument Base;
    static JSSVGDocument* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGDocument>&& impl)
    {
        JSSVGDocument* ptr = new (NotNull, JSC::allocateCell<JSSVGDocument>(globalObject->vm().heap)) JSSVGDocument(structure, *globalObject, WTFMove(impl));
