...
inline JSC::JSValue toJS(JSC::ExecState* state, JSDOMGlobalObject* globalObject, AudioBufferCallback* impl) { return impl ? toJS(state, globalObject, *impl) : JSC::jsNull(); }
