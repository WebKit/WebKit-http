...
EncodedJSValue JSC_HOST_CALL jsDOMSelectionPrototypeFunctionCollapse(ExecState* state)
{
    ...
    impl.collapse(WTFMove(node), WTFMove(index), ec);
...
EncodedJSValue JSC_HOST_CALL jsDOMSelectionPrototypeFunctionContainsNode(ExecState* state)
{
    ...
    if (UNLIKELY(state->hadException()))
        return JSValue::encode(jsUndefined());
    JSValue result = jsBoolean(impl.containsNode(WTFMove(node), WTFMove(allowPartial)));
    return JSValue::encode(result);
}
...
EncodedJSValue JSC_HOST_CALL jsDOMSelectionPrototypeFunctionSelectAllChildren(ExecState* state)
{
    ...
    ExceptionCode ec = 0;
    auto node = JSNode::toWrapped(state->argument(0));
    impl.selectAllChildren(WTFMove(node), ec);
    setDOMException(state, ec);
    return JSValue::encode(jsUndefined());
}
...
EncodedJSValue JSC_HOST_CALL jsDOMSelectionPrototypeFunctionExtend(ExecState* state)
{
    ...
    auto node = JSNode::toWrapped(state->argument(0));
    if (UNLIKELY(!node))
        return throwArgumentTypeError(*state, 0, "node", "DOMSelection", "extend", "Node");
...
EncodedJSValue JSC_HOST_CALL jsDOMSelectionPrototypeFunctionSetBaseAndExtent(ExecState* state)
{
    ...
    auto& impl = castedThis->wrapped();
    ExceptionCode ec = 0;
    auto baseNode = JSNode::toWrapped(state->argument(0));
    auto baseOffset = convert<int32_t>(*state, state->argument(1), NormalConversion);
    if (UNLIKELY(state->hadException()))
        return JSValue::encode(jsUndefined());
    auto extentNode = JSNode::toWrapped(state->argument(2));
    auto extentOffset = convert<int32_t>(*state, state->argument(3), NormalConversion);
    if (UNLIKELY(state->hadException()))
        return JSValue::encode(jsUndefined());
    impl.setBaseAndExtent(WTFMove(baseNode), WTFMove(baseOffset), WTFMove(extentNode), WTFMove(extentOffset), ec);
    setDOMException(state, ec);
    return JSValue::encode(jsUndefined());
}
...
EncodedJSValue JSC_HOST_CALL jsDOMSelectionPrototypeFunctionSetPosition(ExecState* state)
{
    ...
    if (UNLIKELY(state->hadException()))
        return JSValue::encode(jsUndefined());
    impl.setPosition(WTFMove(node), WTFMove(offset), ec);
    setDOMException(state, ec);
    return JSValue::encode(jsUndefined());
}
