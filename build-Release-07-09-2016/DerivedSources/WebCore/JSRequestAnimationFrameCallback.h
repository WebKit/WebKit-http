...
inline JSC::JSValue toJS(JSC::ExecState* state, JSDOMGlobalObject* globalObject, RequestAnimationFrameCallback* impl) { return impl ? toJS(state, globalObject, *impl) : JSC::jsNull(); }
