...
JSC::EncodedJSValue jsWebGLContextAttributesPreferLowPowerToHighPerformance(JSC::ExecState*, JSC::EncodedJSValue, JSC::PropertyName);
bool setJSWebGLContextAttributesPreferLowPowerToHighPerformance(JSC::ExecState*, JSC::EncodedJSValue, JSC::EncodedJSValue);
JSC::EncodedJSValue jsWebGLContextAttributesFailIfMajorPerformanceCaveat(JSC::ExecState*, JSC::EncodedJSValue, JSC::PropertyName);
bool setJSWebGLContextAttributesFailIfMajorPerformanceCaveat(JSC::ExecState*, JSC::EncodedJSValue, JSC::EncodedJSValue);
...
static const HashTableValue JSWebGLContextAttributesPrototypeTableValues[] =
{
    ...
    { "preferLowPowerToHighPerformance", CustomAccessor, NoIntrinsic, { (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsWebGLContextAttributesPreferLowPowerToHighPerformance), (intptr_t) static_cast<PutPropertySlot::PutValueFunc>(setJSWebGLContextAttributesPreferLowPowerToHighPerformance) } },
    { "failIfMajorPerformanceCaveat", CustomAccessor, NoIntrinsic, { (intptr_t)static_cast<PropertySlot::GetValueFunc>(jsWebGLContextAttributesFailIfMajorPerformanceCaveat), (intptr_t) static_cast<PutPropertySlot::PutValueFunc>(setJSWebGLContextAttributesFailIfMajorPerformanceCaveat) } },
};
...
EncodedJSValue jsWebGLContextAttributesPreferLowPowerToHighPerformance(ExecState* state, EncodedJSValue thisValue, PropertyName)
{
    UNUSED_PARAM(state);
    UNUSED_PARAM(thisValue);
    JSValue decodedThisValue = JSValue::decode(thisValue);
    auto* castedThis = jsDynamicCast<JSWebGLContextAttributes*>(decodedThisValue);
    if (UNLIKELY(!castedThis)) {
        return throwGetterTypeError(*state, "WebGLContextAttributes", "preferLowPowerToHighPerformance");
    }
    auto& impl = castedThis->wrapped();
    JSValue result = jsBoolean(impl.preferLowPowerToHighPerformance());
    return JSValue::encode(result);
}


EncodedJSValue jsWebGLContextAttributesFailIfMajorPerformanceCaveat(ExecState* state, EncodedJSValue thisValue, PropertyName)
{
    UNUSED_PARAM(state);
    UNUSED_PARAM(thisValue);
    JSValue decodedThisValue = JSValue::decode(thisValue);
    auto* castedThis = jsDynamicCast<JSWebGLContextAttributes*>(decodedThisValue);
    if (UNLIKELY(!castedThis)) {
        return throwGetterTypeError(*state, "WebGLContextAttributes", "failIfMajorPerformanceCaveat");
    }
    auto& impl = castedThis->wrapped();
    JSValue result = jsBoolean(impl.failIfMajorPerformanceCaveat());
    return JSValue::encode(result);
}
...
bool setJSWebGLContextAttributesPreferLowPowerToHighPerformance(ExecState* state, EncodedJSValue thisValue, EncodedJSValue encodedValue)
{
    JSValue value = JSValue::decode(encodedValue);
    UNUSED_PARAM(thisValue);
    JSWebGLContextAttributes* castedThis = jsDynamicCast<JSWebGLContextAttributes*>(JSValue::decode(thisValue));
    if (UNLIKELY(!castedThis)) {
        return throwSetterTypeError(*state, "WebGLContextAttributes", "preferLowPowerToHighPerformance");
    }
    auto& impl = castedThis->wrapped();
    auto nativeValue = value.toBoolean(state);
    if (UNLIKELY(state->hadException()))
        return false;
    impl.setPreferLowPowerToHighPerformance(WTFMove(nativeValue));
    return true;
}


bool setJSWebGLContextAttributesFailIfMajorPerformanceCaveat(ExecState* state, EncodedJSValue thisValue, EncodedJSValue encodedValue)
{
    JSValue value = JSValue::decode(encodedValue);
    UNUSED_PARAM(thisValue);
    JSWebGLContextAttributes* castedThis = jsDynamicCast<JSWebGLContextAttributes*>(JSValue::decode(thisValue));
    if (UNLIKELY(!castedThis)) {
        return throwSetterTypeError(*state, "WebGLContextAttributes", "failIfMajorPerformanceCaveat");
    }
    auto& impl = castedThis->wrapped();
    auto nativeValue = value.toBoolean(state);
    if (UNLIKELY(state->hadException()))
        return false;
    impl.setFailIfMajorPerformanceCaveat(WTFMove(nativeValue));
    return true;
}
