...
public:
    ...
    typedef CSSCharsetRule DOMWrapped;
    static JSCSSCharsetRule* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<CSSCharsetRule>&& impl)
    {
        JSCSSCharsetRule* ptr = new (NotNull, JSC::allocateCell<JSCSSCharsetRule>(globalObject->vm().heap)) JSCSSCharsetRule(structure, *globalObject, WTFMove(impl));
