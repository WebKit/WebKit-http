...
{var position=str.length-suffix.length;if(position<0)
return false;return str.indexOf(suffix,position)===position;}
...
var isArrayLike=false;try{isArrayLike=injectedScript._subtype(object)==="array"&&isFinite(object.length);}catch(e){}
for(var o=object;this._isDefined(o);o=o.__proto__){var isOwnProperty=o===object;if(isArrayLike&&isOwnProperty)
...
this.preview=this._generatePreview(object,undefined,columnNames);};InjectedScript.RemoteObject.createObjectPreviewForValue=function(value,generatePreview)
...
property.subtype=subtype;if((secondLevelKeys===null||secondLevelKeys)||this._isPreviewableObject(value,object)){var subPreview=InjectedScript.RemoteObject.createObjectPreviewForValue(value,value!==object);property.valuePreview=subPreview;if(!subPreview.lossless)
...
{var scope={object:injectedScript._wrapObject(object,groupId),type:InjectedScript.CallFrameProxy._scopeTypeNames[type],};if(name)
scope.name=name;if(location)
scope.location=location;return scope;}
