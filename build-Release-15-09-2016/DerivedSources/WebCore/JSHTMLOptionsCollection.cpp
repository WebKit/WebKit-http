...
static inline EncodedJSValue jsHTMLOptionsCollectionPrototypeFunctionAdd1(ExecState* state)
{
    ...
    auto before = JSHTMLElement::toWrapped(state->argument(1));
...
EncodedJSValue JSC_HOST_CALL jsHTMLOptionsCollectionPrototypeFunctionAdd(ExecState* state)
{
    ...
    if ((argsCount == 1 && ((arg0.isObject() && asObject(arg0)->inherits(JSHTMLElement::info())))) || (argsCount == 2 && ((arg0.isObject() && asObject(arg0)->inherits(JSHTMLElement::info()))) && (arg1.isUndefinedOrNull() || (arg1.isObject() && asObject(arg1)->inherits(JSHTMLElement::info())))))
