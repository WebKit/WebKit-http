...
public:
    ...
    {
        JSWebGLContextAttributes* ptr = new (NotNull, JSC::allocateCell<JSWebGLContextAttributes>(globalObject->vm().heap)) JSWebGLContextAttributes(structure, *globalObject, WTFMove(impl));
...
inline void* wrapperKey(WebGLContextAttributes* wrappableObject)
{
    return wrappableObject;
}

JSC::JSValue toJS(JSC::ExecState*, JSDOMGlobalObject*, WebGLContextAttributes&);
inline JSC::JSValue toJS(JSC::ExecState* state, JSDOMGlobalObject* globalObject, WebGLContextAttributes* impl) { return impl ? toJS(state, globalObject, *impl) : JSC::jsNull(); }
JSC::JSValue toJSNewlyCreated(JSC::ExecState*, JSDOMGlobalObject*, Ref<WebGLContextAttributes>&&);
inline JSC::JSValue toJSNewlyCreated(JSC::ExecState* state, JSDOMGlobalObject* globalObject, RefPtr<WebGLContextAttributes>&& impl) { return impl ? toJSNewlyCreated(state, globalObject, impl.releaseNonNull()) : JSC::jsNull(); }
