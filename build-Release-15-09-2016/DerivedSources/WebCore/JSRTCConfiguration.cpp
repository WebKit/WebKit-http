...
JSString* jsStringWithCache(ExecState* state, RTCConfiguration::IceTransportPolicy enumerationValue)
{
    ...
    static_assert(static_cast<size_t>(RTCConfiguration::IceTransportPolicy::Public) == 0, "RTCConfiguration::IceTransportPolicy::Public is not 0 as expected");
    static_assert(static_cast<size_t>(RTCConfiguration::IceTransportPolicy::Relay) == 1, "RTCConfiguration::IceTransportPolicy::Relay is not 1 as expected");
    static_assert(static_cast<size_t>(RTCConfiguration::IceTransportPolicy::All) == 2, "RTCConfiguration::IceTransportPolicy::All is not 2 as expected");
...
template<> Optional<RTCConfiguration::IceTransportPolicy> parse<RTCConfiguration::IceTransportPolicy>(ExecState& state, JSValue value)
{
    ...
    if (stringValue == "public")
        return RTCConfiguration::IceTransportPolicy::Public;
