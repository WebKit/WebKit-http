...
inline JSC::JSValue toJS(JSC::ExecState* state, JSDOMGlobalObject* globalObject, MediaStreamTrackSourcesCallback* impl) { return impl ? toJS(state, globalObject, *impl) : JSC::jsNull(); }
