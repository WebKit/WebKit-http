...
Dependencies can be installed (for a gcc2hybrid version) via:
    ...
    $ pkgman install cmake_x86 gperf sqlite_x86_devel libxml2_x86_devel libxslt_x86_devel icu_x86_devel icu_devel perl python ruby libexecinfo_x86_devel libwebp_x86_devel

Or, if you build Haiku from source you can add the packages to your UserBuildConfig:

    AddHaikuImagePackages cmake_x86 gperf sqlite_x86_devel libxml2_x86_devel libxslt_devel icu_x86_devel icu_devel perl python ruby libexecinfo_x86_devel libwebp_x86_devel ;
