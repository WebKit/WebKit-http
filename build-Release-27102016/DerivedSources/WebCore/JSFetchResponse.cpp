...
EncodedJSValue jsFetchResponseType(ExecState* state, EncodedJSValue thisValue, PropertyName)
{
    ...
    if (UNLIKELY(!castedThis)) {
        return throwGetterTypeError(*state, "Response", "type");
    }
...
EncodedJSValue jsFetchResponseUrl(ExecState* state, EncodedJSValue thisValue, PropertyName)
{
    ...
    auto* castedThis = jsDynamicCast<JSFetchResponse*>(decodedThisValue);
    if (UNLIKELY(!castedThis)) {
        return throwGetterTypeError(*state, "Response", "url");
    }
    auto& impl = castedThis->wrapped();
...
EncodedJSValue jsFetchResponseRedirected(ExecState* state, EncodedJSValue thisValue, PropertyName)
{
    ...
    auto* castedThis = jsDynamicCast<JSFetchResponse*>(decodedThisValue);
    if (UNLIKELY(!castedThis)) {
        return throwGetterTypeError(*state, "Response", "redirected");
    }
    auto& impl = castedThis->wrapped();
...
EncodedJSValue jsFetchResponseStatus(ExecState* state, EncodedJSValue thisValue, PropertyName)
{
    ...
    auto* castedThis = jsDynamicCast<JSFetchResponse*>(decodedThisValue);
    if (UNLIKELY(!castedThis)) {
        return throwGetterTypeError(*state, "Response", "status");
    }
    auto& impl = castedThis->wrapped();
...
EncodedJSValue jsFetchResponseOk(ExecState* state, EncodedJSValue thisValue, PropertyName)
{
    ...
    auto* castedThis = jsDynamicCast<JSFetchResponse*>(decodedThisValue);
    if (UNLIKELY(!castedThis)) {
        return throwGetterTypeError(*state, "Response", "ok");
    }
    auto& impl = castedThis->wrapped();
...
EncodedJSValue jsFetchResponseStatusText(ExecState* state, EncodedJSValue thisValue, PropertyName)
{
    ...
    auto* castedThis = jsDynamicCast<JSFetchResponse*>(decodedThisValue);
    if (UNLIKELY(!castedThis)) {
        return throwGetterTypeError(*state, "Response", "statusText");
    }
    auto& impl = castedThis->wrapped();
...
EncodedJSValue jsFetchResponseHeaders(ExecState* state, EncodedJSValue thisValue, PropertyName)
{
    ...
    auto* castedThis = jsDynamicCast<JSFetchResponse*>(decodedThisValue);
    if (UNLIKELY(!castedThis)) {
        return throwGetterTypeError(*state, "Response", "headers");
    }
    auto& impl = castedThis->wrapped();
...
EncodedJSValue jsFetchResponseBodyUsed(ExecState* state, EncodedJSValue thisValue, PropertyName)
{
    ...
    auto* castedThis = jsDynamicCast<JSFetchResponse*>(decodedThisValue);
    if (UNLIKELY(!castedThis)) {
        return throwGetterTypeError(*state, "Response", "bodyUsed");
    }
    auto& impl = castedThis->wrapped();
...
EncodedJSValue JSC_HOST_CALL jsFetchResponsePrototypeFunctionCloneForJS(ExecState* state)
{
    ...
    if (UNLIKELY(!castedThis))
        return throwThisTypeError(*state, "Response", "cloneForJS");
...
EncodedJSValue JSC_HOST_CALL jsFetchResponsePrototypeFunctionStartConsumingStream(ExecState* state)
{
    ...
    auto castedThis = jsDynamicCast<JSFetchResponse*>(thisValue);
    if (UNLIKELY(!castedThis))
        return throwThisTypeError(*state, "Response", "startConsumingStream");
    ASSERT_GC_OBJECT_INHERITS(castedThis, JSFetchResponse::info());
    auto& impl = castedThis->wrapped();
    if (UNLIKELY(state->argumentCount() < 1))
        return throwVMError(state, createNotEnoughArgumentsError(state));
    auto type = convert<uint16_t>(*state, state->argument(0), NormalConversion);
    if (UNLIKELY(state->hadException()))
        return JSValue::encode(jsUndefined());
...
EncodedJSValue JSC_HOST_CALL jsFetchResponsePrototypeFunctionConsumeChunk(ExecState* state)
{
    ...
    auto castedThis = jsDynamicCast<JSFetchResponse*>(thisValue);
    if (UNLIKELY(!castedThis))
        return throwThisTypeError(*state, "Response", "consumeChunk");
    ASSERT_GC_OBJECT_INHERITS(castedThis, JSFetchResponse::info());
    auto& impl = castedThis->wrapped();
    if (UNLIKELY(state->argumentCount() < 1))
        return throwVMError(state, createNotEnoughArgumentsError(state));
    auto chunk = toUint8Array(state->argument(0));
    if (UNLIKELY(state->hadException()))
        return JSValue::encode(jsUndefined());
    if (UNLIKELY(!chunk))
        return throwArgumentTypeError(*state, 0, "chunk", "Response", "consumeChunk", "Uint8Array");
...
#if ENABLE(STREAMS_API)
static EncodedJSValue jsFetchResponsePrototypeFunctionFinishConsumingStreamPromise(ExecState*, JSPromiseDeferred*);
EncodedJSValue JSC_HOST_CALL jsFetchResponsePrototypeFunctionFinishConsumingStream(ExecState* state)
{
    return JSValue::encode(callPromiseFunction(*state, jsFetchResponsePrototypeFunctionFinishConsumingStreamPromise));
}

static inline EncodedJSValue jsFetchResponsePrototypeFunctionFinishConsumingStreamPromise(ExecState* state, JSPromiseDeferred* promiseDeferred)
{
    JSValue thisValue = state->thisValue();
    auto castedThis = jsDynamicCast<JSFetchResponse*>(thisValue);
    if (UNLIKELY(!castedThis))
        return throwThisTypeError(*state, "Response", "finishConsumingStream");
    ASSERT_GC_OBJECT_INHERITS(castedThis, JSFetchResponse::info());
    auto& impl = castedThis->wrapped();
    impl.finishConsumingStream(DeferredWrapper(state, castedThis->globalObject(), promiseDeferred));
    return JSValue::encode(jsUndefined());
}

#endif

static EncodedJSValue jsFetchResponsePrototypeFunctionConsumePromise(ExecState*, JSPromiseDeferred*);
EncodedJSValue JSC_HOST_CALL jsFetchResponsePrototypeFunctionConsume(ExecState* state)
{
    return JSValue::encode(callPromiseFunction(*state, jsFetchResponsePrototypeFunctionConsumePromise));
}

static inline EncodedJSValue jsFetchResponsePrototypeFunctionConsumePromise(ExecState* state, JSPromiseDeferred* promiseDeferred)
{
    JSValue thisValue = state->thisValue();
    auto castedThis = jsDynamicCast<JSFetchResponse*>(thisValue);
    if (UNLIKELY(!castedThis))
        return throwThisTypeError(*state, "Response", "consume");
    ASSERT_GC_OBJECT_INHERITS(castedThis, JSFetchResponse::info());
    auto& impl = castedThis->wrapped();
    if (UNLIKELY(state->argumentCount() < 1))
        return throwVMError(state, createNotEnoughArgumentsError(state));
    ...
    if (UNLIKELY(state->hadException()))
        return JSValue::encode(jsUndefined());
    impl.consume(WTFMove(type), DeferredWrapper(state, castedThis->globalObject(), promiseDeferred));
    return JSValue::encode(jsUndefined());
}
...
EncodedJSValue JSC_HOST_CALL jsFetchResponsePrototypeFunctionSetStatus(ExecState* state)
{
    ...
    auto castedThis = jsDynamicCast<JSFetchResponse*>(thisValue);
    if (UNLIKELY(!castedThis))
        return throwThisTypeError(*state, "Response", "setStatus");
    ASSERT_GC_OBJECT_INHERITS(castedThis, JSFetchResponse::info());
    auto& impl = castedThis->wrapped();
    if (UNLIKELY(state->argumentCount() < 2))
        return throwVMError(state, createNotEnoughArgumentsError(state));
    ExceptionCode ec = 0;
    auto status = convert<uint16_t>(*state, state->argument(0), NormalConversion);
    if (UNLIKELY(state->hadException()))
        return JSValue::encode(jsUndefined());
    auto statusText = state->argument(1).toWTFString(state);
    if (UNLIKELY(state->hadException()))
        return JSValue::encode(jsUndefined());
...
EncodedJSValue JSC_HOST_CALL jsFetchResponsePrototypeFunctionInitializeWith(ExecState* state)
{
    ...
    auto castedThis = jsDynamicCast<JSFetchResponse*>(thisValue);
    if (UNLIKELY(!castedThis))
        return throwThisTypeError(*state, "Response", "initializeWith");
    ASSERT_GC_OBJECT_INHERITS(castedThis, JSFetchResponse::info());
    auto& impl = castedThis->wrapped();
    if (UNLIKELY(state->argumentCount() < 1))
        return throwVMError(state, createNotEnoughArgumentsError(state));
...
EncodedJSValue JSC_HOST_CALL jsFetchResponsePrototypeFunctionCreateReadableStreamSource(ExecState* state)
{
    ...
    auto castedThis = jsDynamicCast<JSFetchResponse*>(thisValue);
    if (UNLIKELY(!castedThis))
        return throwThisTypeError(*state, "Response", "createReadableStreamSource");
    ASSERT_GC_OBJECT_INHERITS(castedThis, JSFetchResponse::info());
    auto& impl = castedThis->wrapped();
...
EncodedJSValue JSC_HOST_CALL jsFetchResponsePrototypeFunctionIsDisturbed(ExecState* state)
{
    ...
    auto castedThis = jsDynamicCast<JSFetchResponse*>(thisValue);
    if (UNLIKELY(!castedThis))
        return throwThisTypeError(*state, "Response", "isDisturbed");
    ASSERT_GC_OBJECT_INHERITS(castedThis, JSFetchResponse::info());
    auto& impl = castedThis->wrapped();
    JSValue result = jsBoolean(impl.isDisturbed());
    return JSValue::encode(result);
