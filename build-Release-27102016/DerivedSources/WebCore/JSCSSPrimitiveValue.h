...
public:
    ...
    typedef CSSPrimitiveValue DOMWrapped;
    static JSCSSPrimitiveValue* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<CSSPrimitiveValue>&& impl)
    {
        JSCSSPrimitiveValue* ptr = new (NotNull, JSC::allocateCell<JSCSSPrimitiveValue>(globalObject->vm().heap)) JSCSSPrimitiveValue(structure, *globalObject, WTFMove(impl));
