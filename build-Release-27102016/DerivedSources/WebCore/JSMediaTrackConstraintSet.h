...
public:
    ...
    {
        JSMediaTrackConstraintSet* ptr = new (NotNull, JSC::allocateCell<JSMediaTrackConstraintSet>(globalObject->vm().heap)) JSMediaTrackConstraintSet(structure, *globalObject, WTFMove(impl));
...
inline void* wrapperKey(MediaTrackConstraintSet* wrappableObject)
{
    return wrappableObject;
}

JSC::JSValue toJS(JSC::ExecState*, JSDOMGlobalObject*, MediaTrackConstraintSet&);
inline JSC::JSValue toJS(JSC::ExecState* state, JSDOMGlobalObject* globalObject, MediaTrackConstraintSet* impl) { return impl ? toJS(state, globalObject, *impl) : JSC::jsNull(); }
JSC::JSValue toJSNewlyCreated(JSC::ExecState*, JSDOMGlobalObject*, Ref<MediaTrackConstraintSet>&&);
inline JSC::JSValue toJSNewlyCreated(JSC::ExecState* state, JSDOMGlobalObject* globalObject, RefPtr<MediaTrackConstraintSet>&& impl) { return impl ? toJSNewlyCreated(state, globalObject, impl.releaseNonNull()) : JSC::jsNull(); }
