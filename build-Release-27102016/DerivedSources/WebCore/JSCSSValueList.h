...
public:
    ...
    typedef CSSValueList DOMWrapped;
    static JSCSSValueList* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<CSSValueList>&& impl)
    {
        JSCSSValueList* ptr = new (NotNull, JSC::allocateCell<JSCSSValueList>(globalObject->vm().heap)) JSCSSValueList(structure, *globalObject, WTFMove(impl));
