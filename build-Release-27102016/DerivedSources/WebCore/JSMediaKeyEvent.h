...
public:
    ...
    typedef MediaKeyEvent DOMWrapped;
    static JSMediaKeyEvent* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<MediaKeyEvent>&& impl)
    {
        JSMediaKeyEvent* ptr = new (NotNull, JSC::allocateCell<JSMediaKeyEvent>(globalObject->vm().heap)) JSMediaKeyEvent(structure, *globalObject, WTFMove(impl));
    ...
    MediaKeyEvent& wrapped() const
    {
        return static_cast<MediaKeyEvent&>(Base::wrapped());
    }
protected:
