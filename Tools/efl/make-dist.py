...
if __name__ == "__main__":
    ...
    def ensure_version_if_possible(arguments):
        ...
        pkgconfig_file = os.path.join(arguments.build_dir, "Source/WebKit2/ewebkit2.pc")
    ...
    parser.add_argument('-t', '--tarball-name', type=str, default='ewebkit',
                        help='Base name of tarball. Defaults to "ewebkit".')
    parser.add_argument('-p', '--port', type=str, default='EFL',
                        help='Port to be built in tarball check. Defaults to "EFL".')
