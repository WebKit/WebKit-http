...
#include "BuildInfo.h"  // generated by Tools/haiku/generate-build-info.sh
...
/*static*/ BString
WebKitInfo::HaikuWebKitRevision()
{
	return HAIKU_WEBKIT_REVISION;
}
